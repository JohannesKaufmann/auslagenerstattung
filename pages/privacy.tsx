    ...
    <div className="p-8 text-gray-900">
      ...
      <div>
        <p>
          ...
          Außerdem können Dateien hinzugefügt werden. Dies ist notwendig, um die
          Erstellung des PDFs zu ermöglichen.
          <br />
        </p>
        <div className="h-1.5" />
        ...
        <p>
          ...
          <span className="font-semibold">bleiben lokal im Browser</span>. Somit
          werden diese Daten{" "}
      ...
      <div>
        ...
        <p>
          ...
          einer Anfrage standardmäßig Daten wie IP-Adresse, Browser-Version und
          andere Metadaten mit an den Server. Vercel speichert und verarbeitet
          diese Daten zum Zweck des Betriebs, der Aufrechterhaltung und der
          Verbesserung des Service. Die Verarbeitung dieser Daten ist technisch
          notwendig, um die Nutzung der Website zu ermöglichen{" "}
          <LegalQuote place="Art. 6 Abs. 1 Bst. b" />.
        </p>
      </div>
    </div>
  );
